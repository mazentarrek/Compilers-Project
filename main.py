...
def open_win():
   ...
   class StartPage(tk.Frame):
      def __init__(self, parent, controller):
         ...
         label3 = tk.Label(self, text=tracefinal(T.get()), font=(("Times New Roman"), 15), pady=10, fg="red")
         label3.pack()


         label4 = tk.Label(self, text="Regular Expression: ((ID | NUM) OP)* (ID|NUM))", font=(("Times New Roman"), 15), pady=20, fg="purple")
         label4.pack()
